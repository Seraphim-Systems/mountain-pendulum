"""Train a tabular Q-learning policy on MountainCar-v0."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train Q-learning on MountainCar-v0")
    parser.add_argument(
        "--config",
        default="configs/q_learning_separate.yaml",
